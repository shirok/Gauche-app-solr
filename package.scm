;;
;; Package Gauche-app-solr
;;

(define-gauche-package "Gauche-app-solr"
  ;; 
  :version "1.0"

  ;; Description of the package.  The first line is used as a short
  ;; summary.
  :description "Apache Solr binding of Gauche"
  ...
  :repository "http://github.com/shirok/Gauche-app-solr.git"
  )
